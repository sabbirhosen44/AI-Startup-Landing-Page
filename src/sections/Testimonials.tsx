    ...
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-white/70 text-lg md:text-xl text-center mt-5 tracking-tight max-w-sm mx-auto">
          Our revolutionary AI SEO tools have transformed our clients&apos;s
          strategies.
        </p>
            ...
            {testimonials.map((testimonial) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mt-5">
                  <div>
                    <div className="relative after:content-[''] after:absolute after:inset-0 after:bg-[rgb(140,69,244)] after:mix-blend-soft-light before:absolute before:inset-0 before:border before:border-white/30 before:z-10 before:rounded-lg">
                      <Image
